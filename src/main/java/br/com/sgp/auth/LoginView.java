...
public class LoginView extends JFrame {
	...
	private void setupFrame() {
		setTitle("SGP - Login");
		setIconImage(new ImageIcon(getClass().getResource("/images/icons/sgp_icon.png")).getImage());
		setSize(480, 520);
	...
	private void addUserIcon() {
		JLabel lblUserIcon = new JLabel(new ImageIcon(getClass().getResource("/images/icons/users_156x156.png")));
